...
(8, 'USD', 'ETH', 1 / 58000.00),  -- Example rate for USD to ETH
(9, 'USD', 'LTC', 1 / 2800.00);    -- Example rate for USD to LTC

-- EUR to BTC, ETH, LTC
INSERT INTO trade_service (id, currency_from, to_currency, rate) VALUES
(10, 'EUR', 'BTC', 1/ 2600.00), -- Example rate for EUR to BTC
(11, 'EUR', 'ETH', 1 / 140.00),  -- Example rate for EUR to ETH
